...
class MutableVector1fInternal(x: Float) : AbstractMutableVector<Float>(x), MutableVector1f {
  override val vectorProducer: (elementProvider: (Int) -> Float) -> MutableVector1f = {
    MutableVector1fInternal(it(0))
  }
}

class MutableVector2fInternal(x: Float, y: Float) :
  AbstractMutableVector<Float>(x, y), MutableVector2f {
  override val vectorProducer: (elementProvider: (Int) -> Float) -> MutableVector2f = {
    MutableVector2fInternal(it(0), it(1))
  }
}

class MutableVector3fInternal(x: Float, y: Float, z: Float) :
  AbstractMutableVector<Float>(x, y, z), MutableVector3f {
  override val vectorProducer: (elementProvider: (Int) -> Float) -> MutableVector3f = {
    MutableVector3fInternal(it(0), it(1), it(2))
  }
}

class MutableVector1iInternal(x: Int) : AbstractMutableVector<Int>(x), MutableVector1i {
  override val vectorProducer: (elementProvider: (Int) -> Int) -> MutableVector1i = {
    MutableVector1iInternal(it(0))
  }
}

class MutableVector2iInternal(x: Int, y: Int) : AbstractMutableVector<Int>(x, y), MutableVector2i {
  override val vectorProducer: (elementProvider: (Int) -> Int) -> MutableVector2i = {
    MutableVector2iInternal(it(0), it(1))
  }
}

class MutableVector3iInternal(x: Int, y: Int, z: Int) :
  AbstractMutableVector<Int>(x, y, z), MutableVector3i {
  override val vectorProducer: (elementProvider: (Int) -> Int) -> MutableVector3i = {
    MutableVector3iInternal(it(0), it(1), it(2))
  }
}
