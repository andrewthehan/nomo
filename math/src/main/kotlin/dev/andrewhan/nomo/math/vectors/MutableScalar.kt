...
operator fun <NumberType : Number, VectorType : MutableVector<NumberType>> VectorType.timesAssign(
  scalar: Scalar<NumberType>
) {
  this *= scalar[0]
}

operator fun <NumberType : Number, VectorType : MutableVector<NumberType>> VectorType.divAssign(
  scalar: Scalar<NumberType>
) {
  this /= scalar[0]
}
